...
function listLocations(params, callback) {
  return function (state) {
    ...
    var _expandReferences10 = (0, _languageCommon.expandReferences)(params)(state),
        headers = _expandReferences10.headers,
        body = _expandReferences10.body,
        options = _expandReferences10.options,
        rest = _objectWithoutProperties(_expandReferences10, ["headers", "body", "options"]);
...
function getLocation(query, params, callback) {
  return function (state) {
    ...
    var _expandReferences11 = (0, _languageCommon.expandReferences)(params)(state),
        headers = _expandReferences11.headers,
        body = _expandReferences11.body,
        options = _expandReferences11.options,
        rest = _objectWithoutProperties(_expandReferences11, ["headers", "body", "options"]);
...
function upsertLocation(params, callback) {
  return function (state) {
    ...
    var _expandReferences12 = (0, _languageCommon.expandReferences)(params)(state),
        externalId = _expandReferences12.externalId,
        data = _expandReferences12.data,
        headers = _expandReferences12.headers,
        body = _expandReferences12.body,
        options = _expandReferences12.options,
        rest = _objectWithoutProperties(_expandReferences12, ["externalId", "data", "headers", "body", "options"]);
